...
$(document.body).on("click", ".c-a-right-img",function(){
    console.log("working");
    console.log(count);
    if(imgNo == count){
    imgNext = imgNo;    
...
$(document.body).on("click", ".c-a-left-img",function(){
    console.log("working");
...
$(document.body).on("click", ".c-a-right-pln",function(){
...
$(document.body).on("click", ".c-a-left-pln",function(){
